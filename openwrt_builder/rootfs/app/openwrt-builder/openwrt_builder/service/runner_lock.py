...
Ensures only one runner process owns the runtime directory at a time.
"""
...
class RunnerLock:
    ...
    def __init__(self, runtime_dir: Path) -> None:
        """Initialize lock and PID file paths within the runtime dir."""
    ...
    def release(self) -> None:
        """Release the lock and remove the PID file if present."""
